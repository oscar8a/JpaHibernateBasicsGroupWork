            ...
            while (runValue) {
                ...
                switch (userChoice) {
                    ...
                    default:
                        ...
                        break;
//                    case 3: int userStatisticChoice = getUserStatisticChoice(userInputService);
...
//            Statistic statistic = entityManager.find(Statistic.class, 1);
//            entityManager.remove(statistic);
    ...
    public static Statistic getDistinctPlayerForNewStatistic(UserInputService userInputService, EntityManager entityManager) {
        String hql = "SELECT Distinct S FROM Statistic S";
